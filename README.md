...
```
cd existing_repo
git remote add origin https://gitlab.com/agile3155110/e-pharmacist.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/agile3155110/e-pharmacist/-/settings/integrations)
